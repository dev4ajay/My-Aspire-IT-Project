...
import { imageNEET2017 } from "../ImagePath";
const Resultneet2017 = () => {
  React.useEffect(() => {
    window.scrollTo({ top: 0 });
  }, []);
  console.log(imageNEET2017);
  return (
    <>
      <Navbar />
            ...
            <div>
              <article class="post clearfix mb-30">
                <div class="entry-header" style={{ columnCount: "4" }}>
                  {imageNEET2017.map((row) => (
                    <div class="post-thumb thumb img_Jee">
                      <img
                        src={row.Threeneetimage}
