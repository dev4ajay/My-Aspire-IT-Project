...
import { imageNEET2018 } from "../ImagePath";
const Resultneet2018 = () => {
  React.useEffect(() => {
    window.scrollTo({ top: 0 });
  }, []);
  console.log(imageNEET2018);
  return (
    <>
      <Navbar />
            ...
            <div>
              <article class="post clearfix mb-30">
                <div class="entry-header" style={{ columnCount: "4" }}>
                  {imageNEET2018.map((row) => (
                    <div class="post-thumb thumb img_Jee">
                      <img
                        src={row.Fourneetimage}
