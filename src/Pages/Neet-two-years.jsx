...
<div>
        ...
        <div class="col-xs-12 col-sm-8 col-md-8 pl-20 pl-sm-15">
              <div>
                ...
                <h5 class="text-theme-colored">IIT JEE Two Years</h5>
				<h5 class="text-theme-colored">Why Choose Ce's Two-Year Classroom Course For Jee Main ?</h5>
                <p>Spectrum is an exhaustive program for students currently studying in Class XI and would be appearing for JEE Main 2021, designed to inculcate the habit of conceptual learning in students. Spread over a span of 2 years the program is designed to help students transit smoothly from class 10th to 12th and build a strong grasp over the concepts of subjects like Mathematics, Chemistry and Physics. Besides Classroom Session and comprehensive Course Material, Online Test Series will also be provided to students. This will help in assessing and improving their performance, besides introducing them to the pattern of the competitive examinations.</p>
                <hr />
