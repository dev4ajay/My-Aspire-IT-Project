...
import { imageNEET2015 } from "../ImagePath";
const Resultneet2015 = () => {
  React.useEffect(() => {
    window.scrollTo({ top: 0 });
  }, []);
  console.log(imageNEET2015);
  return (
    <>
      <Navbar />
            ...
            <div>
              <article class="post clearfix mb-30">
                <div class="entry-header" style={{ columnCount: "4" }}>
                  {imageNEET2015.map((row) => (
                    <div class="post-thumb thumb img_Jee">
                      <img
                        src={row.Oneneetimage}
