...
import { CaarierData } from "../components/data/about";
...
const Caarier = () => {
  ...
  // console.log(CaarierData)
  return (
    <>
      <Navbar />
      <section>
        <div>
          {CaarierData.map((data) => (
            // console.log(data)
            <>
              <div>
              ...
              <div className="container text-justify mt-5 mb-5">
                ...
                <h4 className="headline-brd">
                  {data.heading2}{" "}
                  <span className="color-green">{data.span}</span>
                </h4>
                <div>
