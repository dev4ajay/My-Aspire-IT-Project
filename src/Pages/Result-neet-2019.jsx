...
import { imageNEET2019 } from "../ImagePath";
const Resultneet2019 = () => {
  React.useEffect(() => {
    window.scrollTo({ top: 0 });
  }, []);
  console.log(imageNEET2019);
  return (
    <>
      <Navbar />
            ...
            <div>
              <article class="post clearfix mb-30">
                <div class="entry-header" style={{ columnCount: "4" }}>
                  {imageNEET2019.map((row) => (
                    <div class="post-thumb thumb img_Jee">
                      <img
                        src={row.Fiveneetimage}
